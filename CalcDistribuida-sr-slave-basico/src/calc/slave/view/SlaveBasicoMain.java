...
import calc.slave.controller.SlaveBasicoController;

public class SlaveBasicoMain {
    ...
    private SlaveBasicoController controller;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SlaveBasicoMain window = new SlaveBasicoMain();
	 ...
	 */
	public SlaveBasicoMain() {
		controller = new SlaveBasicoController();
		initialize();
